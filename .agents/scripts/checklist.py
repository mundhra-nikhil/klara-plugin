...
CORE_CHECKS = (
    ...
    CheckSpec("Test Runner", "scripts/gauntlet/test_runner.py", "P3 Testing"),
    ...
    CheckSpec("SEO Check", "scripts/gauntlet/seo_checker.py", "P5 SEO"),
)

URL_CHECKS = (
    CheckSpec("Lighthouse Audit", "scripts/gauntlet/lighthouse_audit.py", "P6 Runtime Checks", target="url", required=True, timeout=180),
    CheckSpec("Playwright Smoke Test", "scripts/gauntlet/playwright_runner.py", "P6 Runtime Checks", target="url", timeout=120),
)
